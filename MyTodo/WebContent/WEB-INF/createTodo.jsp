...
<!-- A RAJOUTER DANS UN FICHIER CSS -->
<style type="text/css">
.ds_box {
...
<body>
	<form method="post" action="createTodo">
		<fieldset>
			...
			<input id="date" onclick="ds_sh(this);" name="date"
				readonly="readonly" style="cursor: text"
				value="${form.contains['date']}" />${form.erreurs['date']}
...
selected
			...
			<script type="text/javascript">
				...
				var ds_monthnames = [ 'Janvier', 'Février', 'Mars', 'Avril',
						'Mai', 'Juin', 'Juillet', 'Aout', 'Septembre',
						'Octobre', 'Novembre', 'Décembre' ]; // You can translate it for your language.

				var ds_daynames = [ 'Dim', 'Lun', 'Mar', 'Me', 'Jeu', 'Ven',
						'Sam' ]; // You can translate it for your language.
				...
				function ds_template_day(d, m, y) {
					return '<td class="ds_cell" onclick="ds_onclick(' + d + ','
							+ m + ',' + y + ')">' + d + '</td>';
